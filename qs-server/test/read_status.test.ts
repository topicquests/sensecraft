...
describe("'read_status' service", function () {
  describe("guild creation", function () {
    ...
    let adminToken: string,
      ...
      a1Id: number,
      arg1Id: number,
      memberIds: NumberObject,
      memberTokens: StringObject,
      roles,
      researcherRoleId: number | undefined,
      philosopherRoleId: number | undefined,
      gameLeaderRoleId: number | undefined,
      tree_info: TreeInfoObject;
    ...
    describe("conversation_node tests", function () {
      ...
      it("can retrieve conversation tree", async function () {
        ...
        console.log("Tree_info: ", tree_info);
