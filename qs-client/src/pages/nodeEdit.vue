      ...
      <div class="col-4">
        <q-card v-if="currentNode">
          <div class = "row justify-start q-pb-lg q-ml-lg">
            <div class="col-4">
              <q-input v-model="currentNode.title" label = "Node title" style='width: 350px'/>
            </div>
          </div>
          <div class = "row justify-start q-pb-lg q-ml-lg">
            <div class="col-4">
          ...
          <div class = "row justify-center q-pb-lg">
            <q-btn label="Edit" @click="editNode" color = "primary" class = "q-mr-md q-ml-md"/>
            <q-btn label="Publish" @click="addNode" color = "primary" class = "q-mr-md q-ml-md"/>
          </div>
        </q-card>
        <q-card v-else>
          <div class = "row justify-start q-pb-lg q-ml-lg">
