              ...
              <template slot="body" slot-scope="props">
                <q-tr :props="props" >
                  ...
                  <q-td v-if="view" key="questNodeId" auto-width :props="props">
                    <router-link :to="{ name: 'quest_page', params: { quest_id:  props.row.id }}">View</router-link>
                  </q-td>
                  <q-td v-else key="questNodeId" auto-width :props="props">
                    <router-link :to="{ name: 'quest_edit', params: { quest_id:  props.row.id }}">Edit</router-link>
                  </q-td>
                </q-tr>
              </template>
            </q-table>
